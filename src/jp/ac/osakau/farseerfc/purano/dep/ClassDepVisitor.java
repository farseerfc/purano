...
public class ClassDepVisitor extends ClassVisitor{
	...
	@Override
	public void visit(int version, int access, @NotNull String name, @org.jetbrains.annotations.Nullable String signature,
	...
	public FieldVisitor	visitField(int access,
			String name, @NotNull String desc, @org.jetbrains.annotations.Nullable String signature, @org.jetbrains.annotations.Nullable Object value){
		printf("    %s %s %s%s%s;\n",
				Types.access2string(access),
