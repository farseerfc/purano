...
public class DepEffect {
	...
	private final DepSet ret = new DepSet();
	private final Map<String, ThisFieldEffect> thisField = new HashMap<>();
	private final Map<String, OtherFieldEffect> otherField = new HashMap<>();
	private final Map<String, StaticFieldEffect> staticField = new HashMap<>();
	private final Set<ArgumentEffect> argumentEffects = new HashSet<>();
	private final Set<CallEffect> callEffects = new HashSet<>();
	private final Set<Effect> otherEffects = new HashSet<>();
...
//			staticField.get(sfe.getKey()).getDeps().merge(sfe.getDeps());
	...
	public String dump(MethodRep rep, Types table, String prefix) {
		...
		deps.add(String.format("%s@%s(%s)", prefix, Escape.annotation("Return"), Escape.effect(ret.dumpDeps(rep, table))));
	...
	public boolean equals(DepEffect other) {
		if (!thisField.keySet().containsAll(other.thisField.keySet()) && other.thisField.keySet().containsAll(thisField.keySet())) {
			return false;
		}
		if (!otherField.keySet().containsAll(other.otherField.keySet()) && other.otherField.keySet().containsAll(otherField.keySet())) {
			return false;
		}
		if (!staticField.keySet().containsAll(other.staticField.keySet()) && other.staticField.keySet().containsAll(staticField.keySet())) {
			return false;
		}
	...
	public DepSet getRet() {
		return this.ret;
	}
	
	@java.lang.SuppressWarnings("all")
	public Map<String, ThisFieldEffect> getThisField() {
		return this.thisField;
	}
	
	@java.lang.SuppressWarnings("all")
	public Map<String, OtherFieldEffect> getOtherField() {
		return this.otherField;
	}
	
	@java.lang.SuppressWarnings("all")
	public Map<String, StaticFieldEffect> getStaticField() {
		return this.staticField;
	}
	
	@java.lang.SuppressWarnings("all")
	public Set<ArgumentEffect> getArgumentEffects() {
		return this.argumentEffects;
	}
	
	@java.lang.SuppressWarnings("all")
	public Set<CallEffect> getCallEffects() {
		return this.callEffects;
	}
	
	@java.lang.SuppressWarnings("all")
	public Set<Effect> getOtherEffects() {
