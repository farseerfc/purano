...
public class ThisFieldEffect extends FieldEffect implements Cloneable {
	...
	protected String dumpEffect(MethodRep rep, Types table) {
		return String.format("%s %s#this.%s: [%s]", table.desc2full(getDesc()), table.fullClassName(getOwner()), getName(), getDeps().dumpDeps(rep, table));
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof ThisFieldEffect)) return false;
		final ThisFieldEffect other = (ThisFieldEffect)o;
	...
	public boolean canEqual(final java.lang.Object other) {
		return other instanceof ThisFieldEffect;
	}
